...
class OpenpayBanks extends PaymentModule
{
    ...
    public function install()
    {
        ...
        $ret = parent::install() && $this->createPendingState() &&                
                ...
                Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_ID_TEST', null) &&
                Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_ID_LIVE', null) &&
                Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_USER', Tools::substr(md5(uniqid(rand(), true)), 0, 10)) &&
                Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_PASSWORD', Tools::substr(md5(uniqid(rand(), true)), 0, 10)) &&                
                Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_URL', _PS_BASE_URL_.__PS_BASE_URI__) &&                
                $this->installDb();
    ...
    {
        /* Eliminar webhooks */
        if (Configuration::get('OPENPAY_SPEI_WEBHOOK_ID_TEST') != null) {
            $this->deleteWebhook(Configuration::get('OPENPAY_SPEI_WEBHOOK_ID_TEST'), false);
        }

        if (Configuration::get('OPENPAY_SPEI_WEBHOOK_ID_LIVE') != null) {
    ...
    public function processPayment()
    {
        ...
        try {
            ...
            $detail = array('{detail}' => $mail_detail, 'pdf_url' => $this->getPdfUrl($result_json->id));
            $this->validateOrder(
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('SubmitOpenpay')) {
            ...
            $configuration_values = array(
                ...
                'OPENPAY_SPEI_WEBHOOK_URL' => trim(Tools::getValue('openpay_webhook_url'))
            );           
            ...
            if (!$this->getMerchantInfo()) {
                ...
                Configuration::deleteByName('OPENPAY_SPEI_WEBHOOK_ID_'.$mode);                
                Configuration::deleteByName('OPENPAY_DEADLINE_SPEI');
            }
        }
    ...
    public function createWebhook($force_host_ssl = false)
    {
        ...
        try {
            ...
            Configuration::updateValue('OPENPAY_SPEI_WEBHOOK_ID_'.$mode, $webhook->id);
            return $webhook;
        } catch (Exception $e) {
