 ...
 * that is bundled with this package iden the file LICENSE.txt.
...
class OpenpayPrestashop extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        {
            $this->backward_error =
                 $this->l('In order to work properly in PrestaShop v1.4, the Openpay module requires the backward compatibility module')
    ...
    public function hookPaymentReturn($params)
    {
        ...
        switch ($transaction['type'])
        {
            case 'store':
                ...
                return $this->display(__FILE__, './views/templates/hook/store_order_confirmation.tpl');
            ...
            case 'bank_account':
                ...
                return $this->display(__FILE__, './views/templates/hook/spei_order_confirmation.tpl');

                break;

            default :
                return $this->display(__FILE__, './views/templates/hook/card_order_confirmation.tpl');
                break;
        }
    }
    ...
    public function processPayment($payment_method, $token = null, $device_session_id = null)
    {
        ...
        try
        {
            ...
            $this->validateOrder(
                    ...
                    $result_json->amount,
                    $this->displayName,
                    $message, array(), null, false, $this->context->customer->secure_key
            );
    ...
    public function getContent()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'openpay_validation' => (empty($this->_validation) ? false : $this->_validation),
            'openpay_error' => (empty($this->_error) ? false : $this->_error),
