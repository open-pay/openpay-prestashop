...
class OpenpayCodiCodiPaymentModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->context->smarty->assign(array(
            'validation_url' => './index.php?process=validation&fc=module&module=openpaycodi&controller=default',
        ...
        $this->setTemplate('codi_execution.tpl');
    }
}
