...
/* To configure, add webhook in account storename.com/modules/openpaycheckoutlending/notification.php */
...
if($json->transaction->method == 'lending'){
    ...
    if ($order) {
        ...
        if ($json->type == 'charge.succeeded' && $charge->status == 'completed') {
            OpenpayCheckoutLending::updatePaidOrderStatus($order,$charge);
